...
class _BabyOjonAndWeekListWidgetState extends State<BabyOjonAndWeekListWidget> {
  ...
  void initState() {
    super.initState();
    // logger.w("Called Baby Ojon part init");
  }
                ...
                child: Column(children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: widget.currentWeights.isEmpty
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (isFoundStartingValue) {
                                  return OjonDataListItem(
                                      week:
                                          "${widget.babyWeekMonthNoModelList[index].num} ${widget.babyWeekMonthNoModelList[index].text} ",
                                      ojon: widget.currentWeights.isEmpty ||
