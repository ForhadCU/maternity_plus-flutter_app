...
import 'package:maa/models/model.babygallery.dart';
import 'package:maa/models/model.image_details.dart';
import 'package:maa/models/model.mom_info.dart';
import 'package:maa/views/screens/baby_gallery/widget/dlg_input.dart';
                                      ...
                                      childAspectRatio: 200 / 244, */
                                        ...
                                        children:
                                          ...
                                          return InkWell(
                                            onTap: () {
                                              logger.d(
                                                  "Caption: ${imgDetailsModelList.caption}");
                                              AwesomeDialog(
                                                  context: context,
                                                  dialogType:
                                                      DialogType.noHeader,
                                                  ...
                                                  body: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      imgDetailsModelList
                                                                  .caption !=
                                                              null && imgDetailsModelList.caption != ""
                                                          ? Container(
                                                              padding:
                                                                  const EdgeInsets
                                                                      .all(8),
          ...
          if (value[i].date == previousDate) {
            ...
            */
            ...
            if (listImageDetailsModel.isNotEmpty) {
              //c: [same] as above mentioned process
              List<ImageDetailsModel> temp = List.from(listImageDetailsModel);
              _listBabyGalleryModelList.add(BabyGalleryModel.nConstructor2(
                imgDetailsModelList: temp,
                dateTime: previousDate,
